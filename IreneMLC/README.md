...
* [Rise, usage and perception](#rise-usage-and-perception)
...
* [Spark Stack](#spark-stack)
	...
	* [MLib](#mlib)
	    ...
	    * [Working of ML Pipelines](#working-of-ml-pipelines)
	* [Spark Streaming](#spark-streaming)
	* [Spark GraphX](#spark-graphx)
* [Spark Programming Languages](#spark-programming-languages)
* [Spark Packages](#spark-packages)
* [Spark in Cloud](#spark-in-cloud)
    * [Spark in AWS Cloud](#spark-in-aws-cloud)
        * [EMR](#emr)
        * [Build own cluster on EC2](#build-own-cluster-on-ec2)
    * [Spark in Google Cloud](#spark-in-google-cloud)
